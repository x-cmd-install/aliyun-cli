...
[![x-cmd/install — aliyun-cli Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/aliyun-cli.svg?lang=zh)](https://x-cmd.com/install/aliyun-cli)

## 安装

```sh
x install aliyun-cli
```

## 代码洞察

合计: **272,922** 行代码（覆盖前 5 种语言、共 **673** 个文件）。
...
- **上游仓库**: <https://github.com/aliyun/aliyun-cli>
- **官网**: <https://help.aliyun.com/zh/cli/>
- **许可证**: Apache-2.0

## 发布

- **最新版本**: `v3.5.1` (2026-09-18)
- **最近提交**: 2026-09-18
- **Release 含资产**: 8 个

## 流行度

- **Star**: 1,106 · **Fork**: 235 · **开放 issue**: 288 · **贡献者**: 58

## 累计统计

- **发布数**: 362 · **已合并 PR**: 593 · **开放 PR**: 19 · **已关闭 issue**: 256 · **开放 issue**: 32 · **提交数**: 1250

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-27 | 2 | 31 | 4 | 2 | 0 | 5 |
| last60d | 2026-07-28 | 3 | 38 | 5 | 2 | 4 | 8 |
| 90d | 2026-06-28 | 11 | 66 | 7 | 3 | 5 | 44 |
| last180d | 2026-03-30 | 34 | 111 | 8 | 10 | 9 | 111 |
| 360d | 2025-10-01 | 63 | 124 | 14 | 13 | 13 | 154 |
| last720d | 2024-10-06 | 100 | 187 | 15 | 26 | 20 | 302 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/aliyun-cli.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260926.yml` · 2026-09-26T04:48:02Z._
